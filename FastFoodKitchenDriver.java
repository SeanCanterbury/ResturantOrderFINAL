...
public class FastFoodKitchenDriver {
    ...
    public static void main(String[] args) {
       ...
       try{
        ...
        while (kitchen.getNumOrdersPending() != 0) {
            ...
            switch (num) {
                ...
                case 3:
                    ...
                    for(BurgerOrder b: kitchen.completedOrders){
                        System.out.println("Completed: " + b.toReport());
                    }
                    break;
                case 4:
                ...
                case 6:
                    ...
                    break;
                case 7:
                //The saveRemainingOrder method and report method writes the information about all orders placed to end of day report and the remaining orders left to the remaining orders
                    kitchen.saveRemainingOrders();
                    kitchen.report();
                    System.exit(0);
                    break;
                default:
        ...
        //This catch accounts for a not number input when traversing through the menu
        }catch (InputMismatchException e){
                    System.out.println("Please enter a valid response RESTART PROGRAM AND TRY AGAIN");
                } catch (Exception i){
                    System.out.println("Something went wrong RESTART PROGRAM AND TRY AGAIN  ");
                }
    } // end main
}// end class
