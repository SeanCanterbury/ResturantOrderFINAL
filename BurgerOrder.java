...
public class BurgerOrder {
    ...
    /**
     * Overriding the toString method to format the output of toString in a better easier to read way
     *
     * @return the string value of the burgerOrder object
     */
    ...
    /**
     * This method functions similar to the toString method but in the formatting of the orders.csv
     * done to have an easy way to output an object in the format deciphered elseware
     *
     * @return the string value of the burgerOrder object in #'s of each item
     */
    public String toStringFile(){
        ...
        return orderNum + "," + numHamburgers + "," + numCheeseburgers + "," + numVeggieburgers + "," + numSodas + "," + togo;
    }

    /**
     * This method formats the information of a burgerOrder object that is output in the end of day report
     *
     * @return the string value of the burgerOrder object in report format
     */
    public String toReport(){
        ...
        return "Order " + orderNum + ": had " + numHamburgers + " Hamburgers, " + numCheeseburgers + " Cheeseburgers, " + numVeggieburgers + " Veggieburgers, " + numSodas + " Sodas, and " +togo;
    }
